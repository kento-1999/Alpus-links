...
export default function PublisherBalancePage() {
  const { user } = useAuth()
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                  ...
                  <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                    <li className="flex items-start space-x-2">
                      ...
                      <span>Balance is added when an order is completed</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="text-green-600 dark:text-green-400 mt-1">•</span>
                      <span>You receive payment after advertiser approves the work</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="text-green-600 dark:text-green-400 mt-1">•</span>
                      <span>Contact admin to withdraw your earnings</span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                  ...
                  <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                    <li className="flex items-start space-x-2">
                      ...
                      <span>Complete orders promptly to receive payments faster</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="text-purple-600 dark:text-purple-400 mt-1">•</span>
                    ...
                    <li className="flex items-start space-x-2">
                      <span className="text-purple-600 dark:text-purple-400 mt-1">•</span>
                      <span>Track your earnings from completed orders</span>
                    </li>
                  </ul>
                </div>
              </div>
